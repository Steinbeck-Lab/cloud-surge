...
2. [Create Cluster in Google Kubernetes Engine(GKE)](/google-cloud-gke/create-cluster.html)
3. [Clone Project and Create Workspace](/google-cloud-gke/clone-project.html)
4. [Create Service Account and Secret](/google-cloud-gke/create-service-account.html)
5. [Create Bucket in Google Cloud Storage](/google-cloud-gke/create-bucket.html)
