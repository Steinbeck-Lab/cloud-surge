...
1. Click the "Create Service Account" button and provide a name and optional description for the service account.
...
1. And then create the file by running the below command in the gcloud terminal
