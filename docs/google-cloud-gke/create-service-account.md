...
<img  src="/gke/service-account.1.png" alt="Service Account" style="width: 100vw">
<img  src="/gke/service-account.2.png" alt="Service Account" style="width: 100vw">
<img  src="/gke/service-account.3.png" alt="Service Account" style="width: 100vw">
<img  src="/gke/service-account.4.png" alt="Service Account" style="width: 100vw">
...
<img  src="/gke/service-account-create-key.1.png" alt="Create Key" style="width: 100vw">

4. Encode the key as base64 by running the below command in your terminal.
```bash
    cat <key-file-name>.json | base64
```
<img  src="/gke/service-account-create-key.2.png" alt="Create Key" style="width: 100vw">
...
<img  src="/gke/create-secret.1.png" alt="Create Secret" style="width: 100vw">
6. And then create the file by running the below command in the gcloud terminal

```bash
kubectl apply -f ./secrets.yml
```
<img  src="/gke/create-secret.2.png" alt="Create Secret" style="width: 100vw">
